...
class SmokeBahsegelMobile(unittest.TestCase):
    ...
    def test_01_landing(self):
        test = BahsegelMobile()
        test.login_mobile("tst_711_0001", 'q1q1q1q1')
        test.landing_pages()
        test.close_driver()

    def test_02_forgot_password(self):
        '''Check forgot password'''
        test2 = BahsegelMobile()
        test2.forgot_password()
        test2.driver.close()

    def test_03_login(self):
        '''Check show password'''
        test_3 = BahsegelMobile()
        test_3.login_mobile("tst_711_0001", 'q1q1q1q1')
        test_3.close_driver()

    def test_04_elements_top_menu(self):
        '''Check top menu elements'''
        test_4 = BahsegelMobile()
        test_4.login_mobile("tst_711_0001", 'q1q1q1q1')
        test_4.top_menu_mobile()
        test_4.driver.close()
